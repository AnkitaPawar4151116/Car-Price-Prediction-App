...
# Load model pipeline
with open('CarProject2.pkl', 'rb') as f:
    pipe = pickle.load(f)

st.title('🚙Intelligent car price evaluator')

st.write("Fill the details below to estimate a good buying price for a used car.")

# Input fields
company = st.text_input("Company Name (e.g., Maruti, Hyundai, Ford etc.)")
name = st.text_input("Car Model Name (e.g., Swift, i20, Figo etc.)")
